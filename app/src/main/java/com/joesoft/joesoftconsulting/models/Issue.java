...
public class Issue implements Parcelable {
    ...
    public Issue(String summary, String status, String description, int priority, String issue_type, Date time_reported, String reporter, String assignee, String issue_id, String project_id) {
